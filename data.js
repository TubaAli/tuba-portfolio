...
const SPRINT = {
  ...
  cases: [
    ...
    { n: 3, status: "live", slug: "ai-collaborator", page: "ai-collaborator.html", icon: "芽",
      ...
      story: [
        { k: "Background",
          p: "I'm pursuing a Master's at Chiba Tech (SDS) alongside my full-time job as a Product Manager in AI. Research happens in the hours around a day job — so every slow loop of coordination costs real progress." },
        { k: "The problem",
          p: "My research — “Does an LLM decide who matters the way people do — and does its sense of care hold together?” — runs with my professor and a few people on his team, aimed at a paper. That brings deadlines and operational load: redundant documents, emails, fixed processes. Coordination is spread across Slack, in-person meetings, and daily updates on my machine and a remote university machine. And most of what people waited on were simple yes/no questions and fact or method checks that never needed my reply — just a check, to unblock them quickly. A shared doc (or my slides) as source of truth didn't work either: nobody digs through a document for a quick answer, and it drifts out of sync. So — what if these trivial, operational, fact-check tasks could be done automatically by my assistant?" },
        { k: "Why I chose this problem", hl: true,
          p: "Most of what blocked us wasn't hard thinking — it was operational: fact checks, tracking agreed vs unagreed decisions, redundant documents, deadline tracking. The shared doc failed because it was pull-based. The problem was never intelligence — it was communication frequency, and faster access to information without effort." },
        { k: "What I built",
          p: "Olo 🌱 — an AI collaborator that lives in our Slack, mirrored by my professor's own agent 🤖. Both are built around a shared outline repo, the project's single source of truth: six files per project — GOALS, CONSTRAINTS, METHODS, DECISIONS, UNAGREED, TRACKING. Each agent runs daily: it reads new Slack messages, repo activity and session logs, the outline, and any open PRs; sorts what it can answer itself (with a citation, or from the knowledge base) from what needs a human; and tags or DMs me by urgency. Every proposed change becomes a per-item Slack thread asking me and my professor (and other stakeholders when needed) for a 👍 — only when everyone has 👍'd does the agent merge it into the outline or KB, carrying the evidence permalink that justifies it. Each run ends in a daily huddle: what's done and agreed, what needs attention, for me to decide, for my professor to decide. Built as a Claude Code agent with a TOML registry; mine drafts in my voice, learned from my real messages." },
      ],
